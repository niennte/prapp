...
echo "    vagrant ssh -c 'composer update'"
echo "** [ZF] Run the following command to log in:
echo "    vagrant ssh"
echo "** [ZF] Visit http://localhost:4321 in your browser for to view the application **"
SCRIPT
